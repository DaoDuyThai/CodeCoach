...
INSERT INTO Feedback (userId, mentorId, bookingId, rating, reviewText, reviewDateTime)
VALUES
...
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(1, 1, 'Collection of Personal Information','When registering for our tutoring system, we may collect personal information such as your name, email address, contact number, and educational background. We may also collect additional information related to your tutoring preferences and requirements. All personal information collected will be kept confidential and will only be used for the purpose of providing tutoring services.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(2, 1, 'Use of Personal Information','The personal information we collect will be used to match you with suitable tutors based on your preferences and requirements. We may use your contact information to communicate with you regarding tutoring services, schedule changes, or other relevant information. Your personal information may be used to improve our services and tailor them to better meet your needs.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(3, 1, 'Protection of Personal Information','We are committed to ensuring the security of your personal information and have implemented appropriate measures to protect it from unauthorized access, disclosure, alteration, or destruction. We use industry-standard security protocols to safeguard your personal information during transmission and storage. Access to your personal information is limited to authorized personnel who require it to provide tutoring services.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(4, 1, 'Disclosure of Personal Information','We do not sell, trade, or rent your personal information to third parties for marketing purposes. However, we may disclose your personal information to tutors or educational institutions when necessary for the purpose of arranging tutoring sessions or fulfilling tutoring requests.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(5, 1, 'Cookies and Tracking Technologies','We may use cookies and similar tracking technologies to enhance your browsing experience on our website. These technologies may collect information such as your IP address, browser type, and browsing patterns, but do not personally identify you. You have the option to disable cookies in your browser settings, although this may affect your ability to use certain features of our website.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(6, 1, 'Third-Party Links','Our website may contain links to third-party websites or services that are not under our control. We are not responsible for the privacy practices or content of these third-party sites. We encourage you to review the privacy policies of these websites before providing any personal information.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(7, 2, 'User Responsibilities','By registering for our tutoring system, you agree to provide accurate and up-to-date information about yourself. You are responsible for maintaining the confidentiality of your account credentials and for any activity that occurs under your account. You agree to use the tutoring services provided through our system for lawful purposes only and not to engage in any fraudulent, abusive, or harmful activities.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(8, 2, 'Tutoring Services','Our tutoring services aim to connect students with qualified tutors based on their preferences and requirements. We strive to match students with tutors who best fit their needs; however, we do not guarantee the availability or suitability of any specific tutor. The scheduling and payment terms for tutoring sessions will be agreed upon between the student and the tutor directly.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(9, 2, 'Intellectual Property','All intellectual property rights, including copyrights and trademarks, related to our tutoring system and website content, belong to us or our licensors. You may not reproduce, modify, distribute, or use any of our intellectual property without prior written permission.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(10, 2, 'Limitation of Liability','We strive to provide accurate and reliable information; however, we do not warrant the completeness, accuracy, or reliability of any information on our website or provided through our tutoring system. We are not liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use our tutoring services or any information obtained from our website.'); 
INSERT INTO PrivacyPolicyAndTerms (id, type, summary, content) VALUES(11, 2, 'Amendments','We reserve the right to modify or update this Privacy Policy and Terms and Conditions at any time without prior notice. Any changes to these policies will be effective immediately upon posting on our website. It is your responsibility to review these policies periodically to stay informed of any updates.'); 
