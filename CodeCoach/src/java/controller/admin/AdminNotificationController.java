 ...
 * @author hoang
 */
@WebServlet(name="AdminNotificationController", urlPatterns={"/AdminNotificationController"})
public class AdminNotificationController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Notifications> list = listN.stream().filter(t -> t.getStatus().equals("Accepted")).collect(Collectors.toList());
