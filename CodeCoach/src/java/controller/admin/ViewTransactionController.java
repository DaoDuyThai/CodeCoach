 ...
 * @author Duy Thai
 */
@WebServlet(name = "ViewTransactionController", urlPatterns = {"/viewtransaction"})
public class ViewTransactionController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Object[]> listAcceptedTransactions = bookingDetailDao.getListAcceptedTransactions();
        request.setAttribute("listAcceptedTransactions", listAcceptedTransactions);
