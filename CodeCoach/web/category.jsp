                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-7 col-lg-8 col-xl-9">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="mb-4">Frequent Category Lists</h4>

                                        <!--add faq start-->
                                        <button  onclick="showAddForm()" type="button" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-success">Add Category</button>
                                        <!-- addForm start here -->
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach items="${listC}" var="c">
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 100px; white-space: pre-wrap;">${c.categoryName}</td>
                                                                    <td style="width: 100px;">
                                                                    <a href="subcategory?categoryId=${c.categoryId}">
