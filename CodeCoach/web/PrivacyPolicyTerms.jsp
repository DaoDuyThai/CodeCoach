                ...
                <div class="account-box">              
                    <div class="login-right">
                        ...
                        <ul>
                            ...
                            <li>We are not responsible for the privacy practices or content of these third-party sites.</li>
                            <li>We encourage you to review the privacy policies of these websites before providing any personal information.</li>
                        </ul>
                        <br>
                        <br>
                        <h1>Terms:</h1>
                        ...
                        <ul>
                            ...
                            <li>Any changes to these policies will be effective immediately upon posting on our website.</li>
