                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="feature-box text-center aos" data-aos="fade-up">
                            ...
                            <p class="mb-0">Are you looking to join online Learning? Now it's very simple, Now Sign up
                            </p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                ...
                <div class="owl-carousel mentoring-course owl-theme">
                    ...
                    <div class="course-box aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="profile.html">
                                    <img class="img-fluid" alt src="assets/img/user/user11.jpg" width="600"
                                        height="300">
                                </a>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="course-box aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="profile.html">
                                    <img class="img-fluid" alt src="assets/img/user/user12.jpg" width="600"
                                        height="300">
                                </a>
                            </div>
                            <div class="product-content">
        ...
        <section class="section path-section">
            ...
            <div class="learning-path-col">
                <div class="container">
                    ...
                    <div class="view-all text-center aos" data-aos="fade-up"><a href="search.html"
                            class="btn btn-primary">View All</a></div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-12">
                        ...
                        <div class="blog grid-blog aos" data-aos="fade-up">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.html">What is Lorem Ipsum? Lorem Ipsum is
                                        simply</a></h3>
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-12">
                        ...
                        <div class="blog grid-blog aos" data-aos="fade-up">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.html">Contrary to popular belief, Lorem
                                        Ipsum is</a></h3>
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do
                                    eiusmod tempor.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-12">
                        ...
                        <div class="blog grid-blog aos" data-aos="fade-up">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.html">The standard chunk of Lorem Ipsum
                                        used</a></h3>
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do
                                    eiusmod tempor.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-12">
                        ...
                        <div class="blog grid-blog aos" data-aos="fade-up">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.html">The standard Lorem Ipsum passage,
                                        used</a></h3>
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do
                                    eiusmod tempor.</p>
                            </div>
                                ...
                                <div class="footer-contact-info">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <a href="https://mentoring.dreamguystech.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="5538303b213a273c3b3215302d34382539307b363a38">[email&#160;protected]</a>
                                    </p>
                                </div>
                            </div>
