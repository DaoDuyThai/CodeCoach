                        ...
                        <div class="col-12">
                                ...
                                <div class="card-body">
                                    <div class="booking-user-info">
                                        ...
                                        <div class="booking-info">
                                            <h4><a href="profile.html">${requestScope.mentor.fName} ${requestScope.mentor.lName}</a></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-8 col-md-6 text-sm-end">
                                    ...
                                    <div class="text-end">
                                    <button type="button" class="btn btn-primary" onclick="changeSlot()">Change Week</button>
                                </div>
                                </div>
