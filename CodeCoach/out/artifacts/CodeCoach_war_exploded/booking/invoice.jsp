                    ...
                    <table class="invoice-table table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                              ${(mentorDAO.getMentorByUserId(mentor.userId)).hourlyRate}
                          </td>
                        </tr>
                        </c:forEach>
                ...
                <div class="col-md-6 col-xl-4 ms-auto">
                  <div class="table-responsive">
                    <table class="invoice-table-two table">
                      ...
                      <tr>
                        <th>Total Amount:</th>
                        <td><span>$${requestScope.bookingDetails.size() * (mentorDAO.getMentorByUserId(mentor.userId)).hourlyRate}</span></td>
                      </tr>
                      </tbody>
                    </table>
                  </div>
